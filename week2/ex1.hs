...
-- Pattern Match (_) não funciona com uma lista, uma gama de valores. Ele compara apenas valor por valor. Por isso não é possível usá-lo se quero verificar se n é menor que 9, pois há vários valores antes do 9.
